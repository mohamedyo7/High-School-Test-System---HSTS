...
@Entity
@Table(name = "x$schema_tables_with_full_table_scans", schema = "sys", catalog = "")
public class X$SchemaTablesWithFullTableScansEntity {
    ...
    public boolean equals(Object o) {
        ...
        X$SchemaTablesWithFullTableScansEntity that = (X$SchemaTablesWithFullTableScansEntity) o;
