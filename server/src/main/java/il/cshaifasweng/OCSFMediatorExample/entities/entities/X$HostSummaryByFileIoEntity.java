...
@Entity
@Table(name = "x$host_summary_by_file_io", schema = "sys", catalog = "")
public class X$HostSummaryByFileIoEntity {
    @Basic
    @Column(name = "host")
    private String host;
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        X$HostSummaryByFileIoEntity that = (X$HostSummaryByFileIoEntity) o;
