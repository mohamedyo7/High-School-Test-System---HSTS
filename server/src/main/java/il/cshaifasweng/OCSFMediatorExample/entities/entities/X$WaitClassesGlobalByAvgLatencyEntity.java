...
@Entity
@Table(name = "x$wait_classes_global_by_avg_latency", schema = "sys", catalog = "")
public class X$WaitClassesGlobalByAvgLatencyEntity {
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        X$WaitClassesGlobalByAvgLatencyEntity that = (X$WaitClassesGlobalByAvgLatencyEntity) o;
