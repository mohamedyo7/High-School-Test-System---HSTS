...
@Entity
@Table(name = "wait_classes_global_by_latency", schema = "sys", catalog = "")
public class WaitClassesGlobalByLatencyEntity {
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        WaitClassesGlobalByLatencyEntity that = (WaitClassesGlobalByLatencyEntity) o;
