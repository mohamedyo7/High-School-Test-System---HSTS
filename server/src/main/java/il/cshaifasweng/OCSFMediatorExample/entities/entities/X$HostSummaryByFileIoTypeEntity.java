...
@Entity
@Table(name = "x$host_summary_by_file_io_type", schema = "sys", catalog = "")
public class X$HostSummaryByFileIoTypeEntity {
    @Basic
    @Column(name = "host")
    private String host;
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        X$HostSummaryByFileIoTypeEntity that = (X$HostSummaryByFileIoTypeEntity) o;
