...
@Entity
@Table(name = "x$user_summary_by_statement_type", schema = "sys", catalog = "")
public class X$UserSummaryByStatementTypeEntity {
    @Basic
    @Column(name = "user")
    private String user;
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        X$UserSummaryByStatementTypeEntity that = (X$UserSummaryByStatementTypeEntity) o;
