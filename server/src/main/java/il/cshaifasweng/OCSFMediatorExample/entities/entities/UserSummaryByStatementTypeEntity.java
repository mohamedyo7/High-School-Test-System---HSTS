...
@Entity
@Table(name = "user_summary_by_statement_type", schema = "sys", catalog = "")
public class UserSummaryByStatementTypeEntity {
    @Basic
    @Column(name = "user")
    private String user;
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        UserSummaryByStatementTypeEntity that = (UserSummaryByStatementTypeEntity) o;
