...
@Entity
@Table(name = "waits_global_by_latency", schema = "sys", catalog = "")
public class WaitsGlobalByLatencyEntity {
    @Basic
    @Column(name = "events")
    ...
    public boolean equals(Object o) {
        ...
        WaitsGlobalByLatencyEntity that = (WaitsGlobalByLatencyEntity) o;
