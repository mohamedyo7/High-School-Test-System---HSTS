...
@Entity
@Table(name = "memory_by_user_by_current_bytes", schema = "sys", catalog = "")
public class MemoryByUserByCurrentBytesEntity {
    @Basic
    @Column(name = "user")
    private String user;
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        MemoryByUserByCurrentBytesEntity that = (MemoryByUserByCurrentBytesEntity) o;
